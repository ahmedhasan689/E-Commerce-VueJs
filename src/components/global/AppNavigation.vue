<template>
  <div class="nav">
    <v-app-bar class="pt-3" color="#161880" height="fit-content">
      <v-container fluid>
        <v-row>
          <v-col cols="3">
          ...
          <v-col cols="4" class="ps-8">
            <div
              class="parent text-white d-flex justify-space-around align-center"
            >
              <div class="available">
              ...
              <div class="wishlist d-flex flex-column align-center">
                ...
                <span style="color: #e7b52d" class="mt-1">WishList</span>
              </div>
              <div class="wishlist d-flex flex-column align-center">
                <svg
                ...
                <span style="color: #e7b52d" class="mt-1">Sign In</span>
              </div>
              <div
              ...
              >
                ...
                <span style="color: #e7b52d" class="mt-1">Cart</span>
              </div>
            </div>
          </v-col>
        </v-row>
